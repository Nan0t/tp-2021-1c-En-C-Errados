...
void segmentacion_memoria_inicializar_tripulante(uint32_t pid, uint32_t tid, u_pos_t pos);

void segmentacion_memoria_actualizar_posicion_tripulante(uint32_t pid, uint32_t tid, u_pos_t pos);
void segmentacion_memoria_actualizar_estado_tripulante(uint32_t pid, uint32_t tid, char estado);
...
void           segmentacion_memoria_expulsar_tripulante(uint32_t pid, uint32_t tid);
