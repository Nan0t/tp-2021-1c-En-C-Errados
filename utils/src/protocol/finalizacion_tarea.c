...
u_msg_finalizacion_tarea_t* u_msg_finalizacion_tarea_crear(uint32_t _tripulante_id, const char* _tarea){
    u_msg_finalizacion_tarea_t* msg = malloc(sizeof(u_msg_finalizacion_tarea_t));
...
u_msg_finalizacion_tarea_t* u_msg_finalizacion_tarea_deserializar(const u_buffer_t* _buffer){
    u_msg_finalizacion_tarea_t* finalizacion_tarea = malloc(sizeof( u_msg_finalizacion_tarea_t));
    uint32_t offset = 0;
    ...
    offset += sizeof(uint32_t);
    finalizacion_tarea->tarea = malloc(sizeof(finalizacion_tarea->largo_nombre_tarea));
