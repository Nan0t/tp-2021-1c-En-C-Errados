 ...
 * @DESC: Serializar un msg_proxima_tarea_t y lo guarda en un struct paquete_t.
 * @PARAMS:
 * 			[in] const msg_proxima_tarea_t* _msg - Mensaje a serializar.
 ...
 * @RETURN: Un msg_proxima_tarea_t que contiene el mensaje deserializado.
 * 
 * @NOTA: El struct resultante debe ser liberado posteriormente llamando a u_msg_informar_proxima_tarea_eliminar.
 */
msg_proxima_tarea_t* u_msg_informar_proxima_tarea_deserializar(const u_buffer_t* _buffer);

/**
 * @NAME: u_msg_informar_proxima_tarea_eliminar
 * @DESC: Elimina un struct msg_proxima_tarea_t
 * @PARAMS:
 * 			[in] msg_proxima_tarea_t* _msg - mensaje a eliminar.
 */
void u_msg_informar_proxima_tarea_eliminar(msg_proxima_tarea_t* _msg);
