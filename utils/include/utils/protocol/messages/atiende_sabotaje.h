...
} u_msg_atender_sabotaje_t;

/**
 * @NAME: u_msg_sabotaje_atiende
 * @DESC: Crea un mensaje u_msg_atender_sabotaje_t
 * @PARAMS:
 * 			[in] uint32_t _tripulante_id - id del tripulante.
 * @RETURN: Un struct u_msg_atender_sabotaje_t.
 ...
 * @DESC: Serializar un u_msg_atender_sabotaje_t y lo guarda en un struct u_paquete_t.
 * @PARAMS:
 * 			[in] const u_msg_atender_sabotaje_t* _msg - Mensaje a serializar.
 * @RETURNS: un struct u_buffer_t que contendra el mensaje serializado.
 */
u_buffer_t* u_msg_atiende_sabotaje_serializar(const u_msg_atender_sabotaje_t* _msg);
 ...
 * @RETURN: Un u_msg_atender_sabotaje_t que contiene el mensaje deserializado.
 * 
 ...
 * @DESC: Elimina un struct u_msg_atender_sabotaje_t
 * @PARAMS:
 * 			[in] u_msg_atender_sabotaje_t* _msg - mensaje a eliminar.
 */
void u_msg_atiende_sabotaje_eliminar(u_msg_atender_sabotaje_t* _msg);

/**
 * @NAME: u_msg_atiende_sabotaje_to_string
 * @DESC: Crea un string representativo del mensaje
 * @PARAMS:
 *          [in] const u_msg_atender_sabotaje_t* msg - mensaje del cual se quiere obtener una representacion en string.
