 ...
 * @DESC: Serializar un u_msg_resuelve_sabotaje_t y lo guarda en un struct u_buffer_t.
 * @PARAMS:
...
/**
 * @NAME: u_msg_resuelve_sabotaje_to_string
 * @DESC: Crea un string representativo del mensaje
 * @PARAMS:
 *          [in] const u_msg_resuelve_sabotaje_t* msg - mensaje del cual se quiere obtener una representacion en string.
