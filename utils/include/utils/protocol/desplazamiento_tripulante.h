...
typedef struct {
    ...
    uint32_t pos_x;
    uint32_t pos_y;
} msg_desplazamiento_tripulante_t;


/**
 * @NAME: u_msg_desplazamiento_tripulante_crear
 * @DESC: Crea un mensaje msg_desplazamiento_tripulante_t
 * @PARAMS:
 ...
 * @RETURN: Un struct msg_desplazamiento_tripulante_t.
 ...
 * @PARAMS:
 * 			[in] const msg_desplazamiento_tripulante_t* _msg - Mensaje a serializar.
 ...
 * @RETURN: Un msg_desplazamiento_tripulante_t que contiene el mensaje deserializado.
 * 
 ...
 * @DESC: Elimina un struct msg_desplazamiento_tripulante_t
 * @PARAMS:
 * 			[in] msg_desplazamiento_tripulante_t* _msg - mensaje a eliminar.
 */
