...
#define LOG_H_
	...
	*/
	...
	void vlog_trace(t_log* logger, const char* message, va_list arguments);
	void vlog_debug(t_log* logger, const char* message, va_list arguments);
	void vlog_info(t_log* logger, const char* message, va_list arguments);
	void vlog_warning(t_log* logger, const char* message, va_list arguments);
	void vlog_error(t_log* logger, const char* message, va_list arguments);
